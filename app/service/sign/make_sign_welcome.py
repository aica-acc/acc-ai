...
- 참고용 마스코트 이미지(URL 또는 로컬 파일 경로)와 축제 정보(한글)를 입력받아서
  ...
  5) run_sign_welcome_to_editor(...) 로 p_no 기준 acc-front/public/data/promotion 경로에
    ...
    반환:
      {
        "db_file_type": "sign_welcome",
        "type": "image",
        "db_file_path": "C:\\...\\acc-front\\public\\data\\promotion\\M000001\\{p_no}\\sign\\sign_welcome.png",
        "type_ko": "입구 표지판"
      }
    """
